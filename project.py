...
def create_df(filename0, filename1, filename2):
    ...
    d1 = {filename1[5:-7]: ['Cycle 0', 'Cycle 1', 'Cycle 2', 'Cycle 3', 'Cycle 4', 'Cycle 5', 'Cycle 6', 'Cycle 7',
                           'Cycle 8'],
    ...
    d2 = {filename1[5:-7]: ['Cycle 0', 'Cycle 1', 'Cycle 2', 'Cycle 3', 'Cycle 4', 'Cycle 5', 'Cycle 6', 'Cycle 7',
                           'Cycle 8'],
...
def graph(title,
    ...
    legend_labels = [filename0[5:-7], filename3[5:-7], filename6[5:-7], filename9[5:-7], filename12[5:-7], filename15[5:-7],
                     filename18[5:-7]]
...
def mean(filename0, filename1, filename2):
    ...
    plt.savefig(f'{filename0[5:-7]}-mean.png')
    plt.show()
...
def std(filename0, filename1, filename2):
    ...
    plt.savefig(f'{filename0[5:-7]}-std.png')
    plt.show()
